plot1 <-function(file_dir="C:/Users/Susanne Haas/Documents/Coursera/Explanatory_data_analysis/Course_Project_1/exdata_data_household_power_consumption", out_dir="C:/Users/Susanne Haas/Documents/Coursera/Explanatory_data_analysis/Course_Project_1"){
  ...
  ## Subset 1-Feb-2007 to 2-Feb-2007
  ...
  hist(hh_power_subset$Global_active_power, main="Global Active Power", xlab="Global Active Power (kilowatts)", ylab ="Frequency", col="red" )
  dev.off()
}